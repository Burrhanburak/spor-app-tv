...
export default function AuthLayout({ children }: React.PropsWithChildren) {
  return (
    <div className="relative grid min-h-screen grid-cols-1 overflow-hidden md:grid-cols-2">
      ...
      <main className="flex w-full items-center justify-center  md:static md:left-0 md:top-0 md:translate-x-0 md:translate-y-0">
        {children}
      </main>
      <div className="relative hidden aspect-video size-full md:block">
        <Image
          src={bgimage}
